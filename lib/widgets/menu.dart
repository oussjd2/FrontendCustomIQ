...
import 'package:avatarmakercopy/Responsive.dart';
import 'package:avatarmakercopy/main.dart';
import 'package:avatarmakercopy/models/menu_modal.dart';
import 'package:flutter_svg/svg.dart';
import 'package:avatarmakercopy/widgets/history.dart';
import 'package:avatarmakercopy/widgets/notifications.dart';
import 'package:avatarmakercopy/widgets/settings_page.dart';
...
class _MenuState extends State<Menu> {
  List<MenuModel> menu = [
    ...
    MenuModel(icon: 'assets/svg/home.svg', title: "User Settings"),
                  ...
                  onTap: () {
                    ...
                    switch (i) {
                      case 0: // Dashboard
                        ...
                        break;
                      case 1: // User Settings, navigate to User List Screen
                        Navigator.of(context).push(
                      ...
                      case 6: // Cultivate Crops
                        Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => const CultivatePage()),
                        );
                        break;
                      case 7: // Exit, close the application
                        SystemNavigator.pop();
                        break;
                    }
                  },
